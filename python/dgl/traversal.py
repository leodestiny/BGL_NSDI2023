...
__all__ = ['multiple_bfs_node_generator_with_mask','bfs_nodes_generator', 'bfs_edges_generator',
           'topological_nodes_generator',
           'dfs_edges_generator', 'dfs_labeled_edges_generator',]

def multiple_bfs_node_generator_with_mask(graph, source, mask, mask_nonzero_count, pass_num, reverse=False):
    gidx = graph._graph
    ret = _CAPI_DGLMultipleBFSNodesWithMask(gidx, F.zerocopy_to_dgl_ndarray(source), reverse, F.zerocopy_to_dgl_ndarray(mask), mask_nonzero_count, pass_num)
