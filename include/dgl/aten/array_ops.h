...
/*!
 * \brief Return the 2D data under the index. In numpy notation, A[I]
 */
NDArray IndexSelect2D(NDArray array, IdArray index);

/*!
 * \brief Fused function IndexSelect2D and Scatter2D_
 */
...
/*!
 * \brief Scatter 2D data into the output array.
 *
 * Equivalent to:
 *
 * <code>
