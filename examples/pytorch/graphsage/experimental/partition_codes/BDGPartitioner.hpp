...
struct normal_BDGPartValue
{
	...
	normal_BDGPartValue();
	// @yrchen: get neighbor id
	int get_neighbor_id(int nb_index) {return neighbors[nb_index];}
};
...
struct label_BDGPartValue
{
	...
	label_BDGPartValue();
	// @yrchen: get neighbor id
	int get_neighbor_id(int nb_index) {return neighbors[nb_index].vid;}
};
...
struct attr_BDGPartValue
{
	...
	attr_BDGPartValue();
	// @yrchen: get neighbor id
	int get_neighbor_id(int nb_index) {return 1;}
};
