...
def training_process(args, labels, worker_id):
    ...
    num_heads = 4
    model = GAT(args.in_feats, args.num_hidden, args.n_classes, args.num_layers, num_heads, F.relu, args.dropout)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_samples_per_worker', type=int, default=0,
        help="number of sampler per worker")
