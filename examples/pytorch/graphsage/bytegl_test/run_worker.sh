...
# run worker in 
#python3.8 train_dist_multi_worker.py --graph_name $GRAPH_NAME --ip_config $DGL_IP_CONFIG --num_epochs $NUM_EPOCHS --batch_size $BATCH_SIZE  --part_config $DGL_CONF_PATH  --fan_out $FAN_OUT --num_partitions $NUM_PARTITIONS --num_workers $NUM_WORKERS --num_samples_per_worker $SAMPLES_PER_WORKER
#python3.8 train_dist_gat_multi_worker.py --graph_name $GRAPH_NAME --ip_config $DGL_IP_CONFIG --num_epochs $NUM_EPOCHS --batch_size $BATCH_SIZE  --part_config $DGL_CONF_PATH  --fan_out $FAN_OUT --num_partitions $NUM_PARTITIONS --num_workers $NUM_WORKERS --num_samples_per_worker $SAMPLES_PER_WORKER
#python3.8 train_dist_gcn_multi_worker.py --graph_name $GRAPH_NAME --ip_config $DGL_IP_CONFIG --num_epochs $NUM_EPOCHS --batch_size $BATCH_SIZE  --part_config $DGL_CONF_PATH  --fan_out $FAN_OUT --num_partitions $NUM_PARTITIONS --num_workers $NUM_WORKERS --num_samples_per_worker $SAMPLES_PER_WORKER
python3.8 train_dist_node_unsuper_multi_worker.py --graph_name $GRAPH_NAME --ip_config $DGL_IP_CONFIG --num_epochs $NUM_EPOCHS --batch_size $BATCH_SIZE  --part_config $DGL_CONF_PATH  --fan_out $FAN_OUT --num_partitions $NUM_PARTITIONS --num_workers $NUM_WORKERS --num_samples_per_worker $SAMPLES_PER_WORKER
