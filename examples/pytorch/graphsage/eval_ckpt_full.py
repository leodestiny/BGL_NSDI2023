...
def run(args, device, data):
    ...
    print("Train nodes # {}, Val nodes # {}, Test nodes # {}.".format(len(train_nid), len(val_nid), len(test_nid) ) )
    ...
    model_path = 'bytegl_model_ckpt/model.iter-0-0-0'
    ...
    for epoch in range(args.num_epochs):
        ...
        for step, (input_nodes, seeds, blocks) in enumerate(dataloader):
            if global_cnt % test_every == 0:
                ...
                model_path = 'bytegl_model_ckpt/model.iter-{}-{}-{}'.format(global_epoch, global_part, global_iter * 5)
